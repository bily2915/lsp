...
-->
	...
	<link rel="stylesheet" href="tmp/css/animate.min.css">
	<link rel="stylesheet" href="tmp/css/font-awesome.min.css">
  	<link rel="stylesheet" href="tmp/css/component.css">
	
    <link rel="stylesheet" href="tmp/css/owl.theme.css">
	<link rel="stylesheet" href="tmp/css/owl.carousel.css">
	<link rel="stylesheet" href="tmp/css/vegas.min.css">
	<link rel="stylesheet" href="tmp/ss/style.css">
  ...
  <div class="navbar navbar-default navbar-fixed-top" role="navigation">
    <div class="container">
      ...
      <div class="navbar-header">
        ...
        <a href="#top" class="navbar-brand smoothScroll">LSP</a>
      </div>
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav navbar-right">
            <li><a href="{{ route('login') }}" class="btn1">
                        Login
                      </a></li>
                      <li><a href="{{ route('register') }}" class="btn1">
                        Register
                      </a></li>
          </ul>
       </div>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-3 col-sm-4 wow fadeInUp about-img" data-wow-delay="0.6s">
        <img src="tmp/images/about-img.jpg" class="img-responsive img-circle" alt="About">
      </div>
      ...
      <div class="item col-md-4 col-sm-6 wow fadeInUp" data-wow-delay="0.4s">
        <div class="team-thumb">
          <div class="image-holder">
            <img src="tmp/images/team-img1.jpg" class="img-responsive img-circle" alt="Mary">
          </div>
      ...
      <div class="item col-md-4 col-sm-6 wow fadeInUp" data-wow-delay="0.6s">
        <div class="team-thumb">
          <div class="image-holder">
            <img src="tmp/images/team-img2.jpg" class="img-responsive img-circle" alt="Jack">
          </div>
      ...
      <div class="item col-md-4 col-sm-6 wow fadeInUp" data-wow-delay="0.8s">
        <div class="team-thumb">
          <div class="image-holder">
            <img src="tmp/images/team-img3.jpg" class="img-responsive img-circle" alt="Linda">
          </div>
      ...
      <div class="item col-md-4 col-sm-6 wow fadeInUp" data-wow-delay="0.8s">
        <div class="team-thumb">
          <div class="image-holder">
            <img src="tmp/images/team-img4.jpg" class="img-responsive img-circle" alt="Sandy">
          </div>
      ...
      <div class="item col-md-4 col-sm-6 wow fadeInUp" data-wow-delay="0.8s">
        <div class="team-thumb">
          <div class="image-holder">
            <img src="tmp/images/team-img5.jpg" class="img-responsive img-circle" alt="Lukia">
          </div>
      ...
      <div class="item col-md-4 col-sm-6 wow fadeInUp" data-wow-delay="0.8s">
        <div class="team-thumb">
          <div class="image-holder">
            <img src="tmp/images/team-img6.jpg" class="img-responsive img-circle" alt="George">
          </div>
      ...
      <div class="item col-md-4 col-sm-6 wow fadeInUp" data-wow-delay="0.8s">
        <div class="team-thumb">
          <div class="image-holder">
            <img src="tmp/images/team-img7.jpg" class="img-responsive img-circle" alt="Day">
          </div>
      ...
      <div class="item col-md-4 col-sm-6 wow fadeInUp" data-wow-delay="0.8s">
        <div class="team-thumb">
          <div class="image-holder">
            <img src="tmp/images/team-img8.jpg" class="img-responsive img-circle" alt="Lynn">
          </div>
    ...
    <div class="row">
      ...
      <ul class="grid cs-style-4">
        <li class="col-md-6 col-sm-6">
          <figure>
            <div><img src="tmp/images/gallery-img1.jpg" alt="image 1"></div>
            <figcaption>
              <h1>Sapien arcu</h1>
        ...
        <li class="col-md-6 col-sm-6">
          <figure>
            <div><img src="tmp/images/gallery-img2.jpg" alt="image 2"></div>
            <figcaption>
              <h1>Aliquam erat</h1>
        ...
        <li class="col-md-6 col-sm-6">
          <figure>
            <div><img src="tmp/images/gallery-img3.jpg" alt="image 3"></div>
            <figcaption>
              <h1>Cras ante sem</h1>
        ...
        <li class="col-md-6 col-sm-6">
          <figure>
            <div><img src="tmp/images/gallery-img4.jpg" alt="image 4"></div>
            <figcaption>
              <h1>Sed ornare</h1>
...
<script src="tmp/js/vegas.min.js"></script>
<script src="tmp/js/modernizr.custom.js"></script>
<script src="tmp/js/toucheffects.js"></script>
<script src="tmp/js/owl.carousel.min.js"></script>
<script src="tmp/js/smoothscroll.js"></script>
