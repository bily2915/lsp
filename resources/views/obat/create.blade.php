...
placeholder="Nama Merk" name="merk" value="{{old('merk')}}">
...
placeholder="Jenis Obat" name="jenis" value="{{old('jenis')}}">
...
placeholder="Satuan Obat" name="satuan" value="{{old('satuan')}}">
...
placeholder="Golongan Obat" name="golongan" value="{{old('golongan')}}">
...
placeholder="Kemasan Obat" name="kemasan" value="{{old('kemasan')}}">
...
placeholder="Harga Jual" name="harga_jual" value="{{old('harga_jual')}}">
...
placeholder="Stok Obat" name="stok" value="{{old('stok')}}">
